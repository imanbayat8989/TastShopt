...
namespace TastShopt.Controllers
{
    ...
    public class ProductApiController : ControllerBase
    {
        ...
        private readonly IProductRepo _dbVilla;
        private readonly IMapper _mapper;
        public ProductApiController(IProductRepo dbVilla, IMapper mapper)
        {
            _dbVilla = dbVilla;
            _mapper = mapper;
            _response = new();
        ...
        public async Task<ActionResult<ApiResponse>> GetProduct([FromQuery(Name = "filterOccupancy")] int? occupancy,
            [FromQuery] string? search, int pageSize = 0, int pageNumber = 1)
        {
            try
            {
                IEnumerable<Product> villaList;
                ...
                _response.Result = _mapper.Map<List<ProductDTO>>(villaList);
        ...
        public async Task<ActionResult<ApiResponse>> CreateProduct([FromBody] ProductCreateDTO createDTO)
        {
            try
            {
                ...
                Product villa = _mapper.Map<Product>(createDTO);
        ...
        public async Task<IActionResult> UpdatePartialProduct(int id, JsonPatchDocument<ProductUpdateDTO> patchDTO)
        {
            ...
            ProductUpdateDTO villaDTO = _mapper.Map<ProductUpdateDTO>(villa);
            ...
            Product model = _mapper.Map<Product>(villaDTO);
